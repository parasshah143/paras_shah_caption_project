...
class TestAndroidDeviceLocal(AppiumConfig):
    ...
    def test_info(self):
        ...
        assert_that(actual_name).is_equal_to("Name: paras")
        assert_that(actual_email).is_equal_to("Email: paras@gmail.com")
        assert_that(actual_password).is_equal_to("Password: paras222")
        assert_that(actual_mobile).is_equal_to("Mobile: 98986622")
